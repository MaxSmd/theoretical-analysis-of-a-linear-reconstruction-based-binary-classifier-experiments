...
* Landauer, M., Skopik, F., & Wurzenberger, M. (2024). [A critical review of common log data sets used for evaluation of sequence-based anomaly detection techniques.](https://doi.org/10.1145/3660768) Proceedings of the ACM on Software Engineering, 1(FSE), 1354-1375. \[[PDF](https://dl.acm.org/doi/pdf/10.1145/3660768)\]
